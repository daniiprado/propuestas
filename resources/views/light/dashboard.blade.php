              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tr>
                    <td>
                      <div class="flag">
                        <img src="{{ asset('light/assets/img/flags/US.png') }}"
                      </div>
                    </td>
                    <td>USA</td>
                    <td class="text-right">
                  ...
                  <tr>
                    <td>
                      <div class="flag">
                        <img src="{{ asset('light/assets/img/flags/DE.png') }}"
                      </div>
                    </td>
                    <td>Germany</td>
                    <td class="text-right">
                  ...
                  <tr>
                    <td>
                      <div class="flag">
                        <img src="{{ asset('light/assets/img/flags/AU.png') }}"
                      </div>
                    </td>
                    <td>Australia</td>
                    <td class="text-right">
                  ...
                  <tr>
                    <td>
                      <div class="flag">
                        <img src="{{ asset('light/assets/img/flags/GB.png') }}"
                      </div>
                    </td>
                  ...
                  <tr>
                    <td>
                      <div class="flag">
                        <img src="{{ asset('light/assets/img/flags/RO.png') }}"
                      </div>
                    </td>
                    <td>Romania</td>
                    <td class="text-right">
                  ...
                  <tr>
                    <td>
                      <div class="flag">
                        <img src="{{ asset('light/assets/img/flags/BR.png') }}"
                      </div>
                    </td>
                    <td>Brasil</td>
                    <td class="text-right">
