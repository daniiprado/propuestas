                  ...
                  <div class="col-md-10 col-md-offset-1">
                    <div class="form-group">
                      ...
                      <input class="form-control"
                             ...
                             name="email"
                             email="true"
                             placeholder="ex: hello@danielprado.me"
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-10 col-md-offset-1">
                    <div class="form-group">
                      ...
                      <input class="form-control"
                             ...
                             name="website"
                             url="true.html"
                             placeholder="ex: http://www.danielprado.me"
                      />
                    </div>
                  </div>
                </div>
...
<script src="{{ asset('light/assets/js/jquery.validate.min.js') }}"></script>
<!-- Sweet Alert 2 plugin -->
<script src="{{ asset('light/assets/js/sweetalert2.js') }}"></script>
<!-- Wizard Plugin    -->
<script src="{{ asset('light/assets/js/jquery.bootstrap.wizard.min.js') }}"></script>
@endpush
