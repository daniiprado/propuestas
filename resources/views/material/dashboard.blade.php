...
@section('navbar')
  @include('material.partials.navbar', ['title' => 'Dashboard'])
@endsection
...
@section('content')
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header card-header-icon" data-background-color="{{ $user['active-color'] }}">
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card card-product">
        <div class="card-image" data-header-animation="true">
          <a href="#pablo">
            <img class="img" src="{{ asset('material/assets/img/card-2.jpg') }}">
          </a>
        </div>
        <div class="card-content">
          <div class="card-actions">
    ...
    <div class="col-md-4">
      <div class="card card-product">
        <div class="card-image" data-header-animation="true">
          <a href="#pablo">
            <img class="img" src="{{ asset('material/assets/img/card-3.jpg') }}">
          </a>
        </div>
        <div class="card-content">
          <div class="card-actions">
    ...
    <div class="col-md-4">
      <div class="card card-product">
        <div class="card-image" data-header-animation="true">
          <a href="javascript:;">
            <img class="img" src="{{ asset('material/assets/img/card-1.jpg') }}">
          </a>
        </div>
        <div class="card-content">
          <div class="card-actions">
