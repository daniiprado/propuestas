...
@section('navbar')
  @include('material.partials.navbar', ['title' => 'Extended Form'])
@endsection
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-3">
                  <select class="selectpicker" data-style="select-with-transition" multiple title="Choose City"
                          data-size="7">
            ...
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-3">
                  <div class="dropdown">
                    <button href="javascript:;" class="dropdown-toggle btn btn-primary btn-round btn-block"
                    ...
                    <ul class="dropdown-menu dropdown-menu-left">
                      ...
                      <li class="divider"></li>
                      <li>
                        <a href="javascript:;">One more separated link</a>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div class="col-md-4 col-sm-4">
              ...
              <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                <div class="fileinput-new thumbnail">
                  <img src="{{ asset('material/assets/img/image_placeholder.jpg') }}" alt="Placeholder">
                </div>
