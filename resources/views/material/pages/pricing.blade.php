...
@section('page-class', 'pricing-page')
@section('page-color', 'black')
@section('page-image', asset('material/assets/img/bg-pricing.jpg'))
        ...
        <div class="col-md-3">
          <div class="card card-pricing card-plain">
            <div class="card-content">
              ...
              <a href="javascript:;" class="btn btn-white btn-round">Choose Plan</a>
            </div>
          </div>
        </div>
        <div class="col-md-3">
          <div class="card card-pricing card-raised">
            <div class="card-content">
              ...
              <a href="javascript:;" class="btn btn-rose btn-round">Choose Plan</a>
            </div>
          </div>
        </div>
        <div class="col-md-3">
