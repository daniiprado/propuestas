...
@section('navbar')
  @include('material.partials.navbar', ['title' => 'Extended Table'])
@endsection
          ...
          <div class="table-responsive">
            <table class="table table-shopping">
              ...
              <tr>
                <td>
                  <div class="img-container">
                    <img src="{{ asset('material/assets/img/product1.jpg') }}" alt="...">
                  </div>
                </td>
                <td class="td-name">
              ...
              <tr>
                <td>
                  <div class="img-container">
                    <img src="{{ asset('material/assets/img/product2.jpg') }}" alt="..." />
                  </div>
                </td>
                <td class="td-name">
              ...
              <tr>
                <td>
                  <div class="img-container">
                    <img src="{{ asset('material/assets/img/product3.jpg') }}" alt="...">
                  </div>
                </td>
                <td class="td-name">
