              ...
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tr>
                    <td>
                      <div class="flag">
                        <img src="{{ asset('paper/assets/img/flags/US.png') }}"
                      </div>
                    </td>
                    <td>USA</td>
                    <td class="text-right">
                  ...
                  <tr>
                    <td>
                      <div class="flag">
                        <img src="{{ asset('paper/assets/img/flags/DE.png') }}"
                      </div>
                    </td>
                    <td>Germany</td>
                    <td class="text-right">
                  ...
                  <tr>
                    <td>
                      <div class="flag">
                        <img src="{{ asset('paper/assets/img/flags/AU.png') }}"
                      </div>
                    </td>
                    <td>Australia</td>
                    <td class="text-right">
                  ...
                  <tr>
                    <td>
                      <div class="flag">
                        <img src="{{ asset('paper/assets/img/flags/GB.png') }}"
                      </div>
                    </td>
                  ...
                  <tr>
                    <td>
                      <div class="flag">
                        <img src="{{ asset('paper/assets/img/flags/RO.png') }}"
                      </div>
                    </td>
                    <td>Romania</td>
                    <td class="text-right">
                  ...
                  <tr>
                    <td>
                      <div class="flag">
                        <img src="{{ asset('paper/assets/img/flags/BR.png') }}"
                      </div>
                    </td>
                    <td>Brasil</td>
                    <td class="text-right">
      ...
      <div class="card card-chat">
        ...
        <div class="card-content">
          <ol class="chat">
            <li class="other">
              <div class="avatar">
                <img src="{{ asset('paper/assets/img/faces/face-2.jpg') }}" alt="crash"/>
              </div>
              <div class="msg">
                <p>
                  Hola!
            ...
            <li class="self">
              ...
              <div class="avatar">
                <img src="{{ asset('paper/assets/img/default-avatar.png') }}" alt="crash"/>
              </div>
            </li>
            <li class="other">
              <div class="avatar">
