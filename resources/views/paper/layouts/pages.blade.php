...
<html lang="{{ config('app.locale') }}">
  ...
  <body>
    ...
    <!--   Core JS Files   -->
    <script src="{{asset('https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js')}}"
            type="text/javascript"></script>
    <script src="{{asset('https://code.jquery.com/ui/1.12.1/jquery-ui.min.js')}}" type="text/javascript"></script>
    <script
        src="{{asset('https://cdnjs.cloudflare.com/ajax/libs/jquery.perfect-scrollbar/0.6.16/js/perfect-scrollbar.jquery.min.js')}}"
        type="text/javascript"></script>
